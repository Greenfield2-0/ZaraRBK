...
function App() {
  ...
  const [slideDirection, setSlideDirection] = useState(1); // 1 represents sliding down, -1 represents sliding up
  const slideInterval = 3000; // Interval in milliseconds between each slide
